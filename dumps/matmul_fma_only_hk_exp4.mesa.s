...
block1 {
   ...
   136 = phi 95, 418
   137 = phi 79, 417
   if_icmp 135, 91, #0xaaaafd67d6e0, n=1, inv
} -> block2 block3  from block0 block12

block2 {
   break #0xaaaafd67bb70, n=2
} -> block13  from block1

block3 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd67d6e0, n=1
   pop_exec #0x0, n=1
} -> block4  from block1

block4 {
   if_icmp u30l, #0, #0xaaaafd694440, n=1, inv
...
block6 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd694440, n=1
   pop_exec #0x0, n=1
} -> block7  from block4
...
block8 {
   ...
   293 = phi 134, 343
   294 = phi #0, 416
   if_icmp 294, #16, #0xaaaafd7c1b60, n=1, inv
} -> block9 block10  from block7 block11

block9 {
   break #0xaaaafd694880, n=2
} -> block12  from block8

block10 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7c1b60, n=1
   pop_exec #0x0, n=1
} -> block11  from block8
...
block13 {
   ...
   if_icmp 432h, #0, #0xaaaafd7c8d30, n=1, inv
...
block15 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7c8d30, n=1
   pop_exec #0x0, n=1
} -> block16  from block13
...
block16 {
   ...
   if_icmp 441h, #0, #0xaaaafd7c9ba0, n=1, inv
...
block18 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7c9ba0, n=1
   pop_exec #0x0, n=1
} -> block19  from block16
...
block19 {
   ...
   if_icmp 451h, #0, #0xaaaafd7cab90, n=1, inv
...
block21 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7cab90, n=1
   pop_exec #0x0, n=1
} -> block22  from block19
...
block22 {
   ...
   if_icmp 461h, #0, #0xaaaafd7cbb80, n=1, inv
...
block24 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7cbb80, n=1
   pop_exec #0x0, n=1
} -> block25  from block22
...
block25 {
   ...
   if_icmp 470h, #0, #0xaaaafd7cd1a0, n=1, inv
...
block27 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7cd1a0, n=1
   pop_exec #0x0, n=1
} -> block28  from block25
...
block28 {
   ...
   if_icmp 477h, #0, #0xaaaafd7ce050, n=1, inv
...
block30 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7ce050, n=1
   pop_exec #0x0, n=1
} -> block31  from block28
...
block31 {
   ...
   if_icmp 485h, #0, #0xaaaafd7cef00, n=1, inv
...
block33 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7cef00, n=1
   pop_exec #0x0, n=1
} -> block34  from block31
...
block34 {
   ...
   if_icmp 493h, #0, #0xaaaafd7cfdb0, n=1, inv
...
block36 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7cfdb0, n=1
   pop_exec #0x0, n=1
} -> block37  from block34
...
block37 {
   ...
   if_icmp 504h, #0, #0xaaaafd7d0d90, n=1, inv
...
block39 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7d0d90, n=1
   pop_exec #0x0, n=1
} -> block40  from block37
...
block40 {
   ...
   if_icmp 514h, #0, #0xaaaafd7d1e10, n=1, inv
...
block42 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7d1e10, n=1
   pop_exec #0x0, n=1
} -> block43  from block40
...
block43 {
   ...
   if_icmp 525h, #0, #0xaaaafd7d2e90, n=1, inv
...
block45 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7d2e90, n=1
   pop_exec #0x0, n=1
} -> block46  from block43
...
block46 {
   ...
   if_icmp 536h, #0, #0xaaaafd7d3f10, n=1, inv
...
block48 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7d3f10, n=1
   pop_exec #0x0, n=1
} -> block49  from block46
...
block49 {
   ...
   if_icmp 544h, #0, #0xaaaafd7d4d20, n=1, inv
...
block51 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7d4d20, n=1
   pop_exec #0x0, n=1
} -> block52  from block49
...
block52 {
   ...
   if_icmp 551h, #0, #0xaaaafd7d5bd0, n=1, inv
...
block54 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7d5bd0, n=1
   pop_exec #0x0, n=1
} -> block55  from block52
...
block55 {
   ...
   if_icmp 559h, #0, #0xaaaafd7d6a80, n=1, inv
...
block57 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7d6a80, n=1
   pop_exec #0x0, n=1
} -> block58  from block55
...
block58 {
   ...
   if_icmp 567h, #0, #0xaaaafd7d7930, n=1, inv
...
block60 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7d7930, n=1
   pop_exec #0x0, n=1
} -> block61  from block58
...
block61 {
   ...
   if_icmp 576h, #0, #0xaaaafd7d87e0, n=1, inv
...
block63 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7d87e0, n=1
   pop_exec #0x0, n=1
} -> block64  from block61
...
block64 {
   ...
   if_icmp 583h, #0, #0xaaaafd7d9690, n=1, inv
...
block66 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7d9690, n=1
   pop_exec #0x0, n=1
} -> block67  from block64
...
block67 {
   ...
   if_icmp 591h, #0, #0xaaaafd7da540, n=1, inv
...
block69 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7da540, n=1
   pop_exec #0x0, n=1
} -> block70  from block67
...
block70 {
   ...
   if_icmp 599h, #0, #0xaaaafd7db3f0, n=1, inv
...
block72 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7db3f0, n=1
   pop_exec #0x0, n=1
} -> block73  from block70
...
block73 {
   ...
   if_icmp 608h, #0, #0xaaaafd7dc2a0, n=1, inv
...
block75 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7dc2a0, n=1
   pop_exec #0x0, n=1
} -> block76  from block73
...
block76 {
   ...
   if_icmp 615h, #0, #0xaaaafd7ccdd0, n=1, inv
...
block78 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd7ccdd0, n=1
   pop_exec #0x0, n=1
} -> block79  from block76
...
block79 {
   ...
   if_icmp 623h, #0, #0xaaaafd614e10, n=1, inv
...
block81 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd614e10, n=1
   pop_exec #0x0, n=1
} -> block82  from block79
...
block82 {
   ...
   if_icmp 631h, #0, #0xaaaafd615cc0, n=1, inv
...
block84 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd615cc0, n=1
   pop_exec #0x0, n=1
} -> block85  from block82
...
block85 {
   ...
   if_icmp 639h, #0, #0xaaaafd616ad0, n=1, inv
...
block87 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd616ad0, n=1
   pop_exec #0x0, n=1
} -> block88  from block85
...
block88 {
   ...
   if_icmp 646h, #0, #0xaaaafd617980, n=1, inv
...
block90 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd617980, n=1
   pop_exec #0x0, n=1
} -> block91  from block88
...
block91 {
   ...
   if_icmp 654h, #0, #0xaaaafd618830, n=1, inv
...
block93 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd618830, n=1
   pop_exec #0x0, n=1
} -> block94  from block91
...
block94 {
   ...
   if_icmp 662h, #0, #0xaaaafd6196e0, n=1, inv
...
block96 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd6196e0, n=1
   pop_exec #0x0, n=1
} -> block97  from block94
...
block97 {
   ...
   if_icmp 670h, #0, #0xaaaafd61a4f0, n=1, inv
...
block99 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd61a4f0, n=1
   pop_exec #0x0, n=1
} -> block100  from block97
...
block100 {
   ...
   if_icmp 677h, #0, #0xaaaafd61b3a0, n=1, inv
...
block102 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd61b3a0, n=1
   pop_exec #0x0, n=1
} -> block103  from block100
...
block103 {
   ...
   if_icmp 685h, #0, #0xaaaafd61c250, n=1, inv
...
block105 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd61c250, n=1
   pop_exec #0x0, n=1
} -> block106  from block103
...
block106 {
   ...
   if_icmp 693h, #0, #0xaaaafd61d100, n=1, inv
...
block108 {
   else_fcmp #0.000000, #0.000000, #0xaaaafd61d100, n=1
   pop_exec #0x0, n=1
} -> block109  from block106
...
block4 {
   ...
   jmp_exec_none_after #0xaaaafd694880
   if_icmp u30l, #0, #0xaaaafd694440, n=1, inv
   jmp_exec_none #0xaaaafd694440
} -> block5 block6  from block3
...
block13 {
   ...
   if_icmp r0h, #0, #0xaaaafd7c8d30, n=1, inv
} -> block14 block15  from block2
...
block16 {
   ...
   if_icmp r0h, #0, #0xaaaafd7c9ba0, n=1, inv
} -> block17 block18  from block14 block15
...
block19 {
   ...
   if_icmp r0h, #0, #0xaaaafd7cab90, n=1, inv
} -> block20 block21  from block17 block18
...
block22 {
   ...
   if_icmp r0h, #0, #0xaaaafd7cbb80, n=1, inv
} -> block23 block24  from block20 block21
...
block25 {
   ...
   r0h = icmpsel r4, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7cd1a0, n=1, inv
} -> block26 block27  from block23 block24
...
block28 {
   ...
   r0h = icmpsel r3, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7ce050, n=1, inv
} -> block29 block30  from block26 block27
...
block31 {
   ...
   r0h = icmpsel r5, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7cef00, n=1, inv
} -> block32 block33  from block29 block30
...
block34 {
   ...
   r0h = icmpsel r9, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7cfdb0, n=1, inv
} -> block35 block36  from block32 block33
...
block37 {
   ...
   if_icmp r0h, #0, #0xaaaafd7d0d90, n=1, inv
} -> block38 block39  from block35 block36
...
block40 {
   ...
   if_icmp r0h, #0, #0xaaaafd7d1e10, n=1, inv
} -> block41 block42  from block38 block39
...
block43 {
   ...
   if_icmp r0h, #0, #0xaaaafd7d2e90, n=1, inv
} -> block44 block45  from block41 block42
...
block46 {
   ...
   if_icmp r0h, #0, #0xaaaafd7d3f10, n=1, inv
} -> block47 block48  from block44 block45
...
block49 {
   ...
   r0h = icmpsel r11, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7d4d20, n=1, inv
} -> block50 block51  from block47 block48
...
block52 {
   ...
   r0h = icmpsel r12, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7d5bd0, n=1, inv
} -> block53 block54  from block50 block51
...
block55 {
   ...
   r0h = icmpsel r13, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7d6a80, n=1, inv
} -> block56 block57  from block53 block54
...
block58 {
   ...
   r0h = icmpsel r14, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7d7930, n=1, inv
} -> block59 block60  from block56 block57
...
block61 {
   ...
   r0h = icmpsel r4, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7d87e0, n=1, inv
} -> block62 block63  from block59 block60
...
block64 {
   ...
   r0h = icmpsel r3, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7d9690, n=1, inv
} -> block65 block66  from block62 block63
...
block67 {
   ...
   r0h = icmpsel r5, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7da540, n=1, inv
} -> block68 block69  from block65 block66
...
block70 {
   ...
   r0h = icmpsel r9, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7db3f0, n=1, inv
} -> block71 block72  from block68 block69
...
block73 {
   ...
   r0h = icmpsel r4, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7dc2a0, n=1, inv
} -> block74 block75  from block71 block72
...
block76 {
   ...
   r0h = icmpsel r3, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd7ccdd0, n=1, inv
} -> block77 block78  from block74 block75
...
block79 {
   ...
   r0h = icmpsel r5, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd614e10, n=1, inv
} -> block80 block81  from block77 block78
...
block82 {
   ...
   r0h = icmpsel r9, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd615cc0, n=1, inv
} -> block83 block84  from block80 block81
...
block85 {
   ...
   r0h = icmpsel r11, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd616ad0, n=1, inv
} -> block86 block87  from block83 block84
...
block88 {
   ...
   r0h = icmpsel r12, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd617980, n=1, inv
} -> block89 block90  from block86 block87
...
block91 {
   ...
   r0h = icmpsel r13, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd618830, n=1, inv
} -> block92 block93  from block89 block90
...
block94 {
   ...
   r0h = icmpsel r14, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd6196e0, n=1, inv
} -> block95 block96  from block92 block93
...
block97 {
   ...
   r0h = icmpsel r11, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd61a4f0, n=1, inv
} -> block98 block99  from block95 block96
...
block100 {
   ...
   r0h = icmpsel r12, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd61b3a0, n=1, inv
} -> block101 block102  from block98 block99
...
block103 {
   ...
   r0h = icmpsel r13, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd61c250, n=1, inv
} -> block104 block105  from block101 block102
...
block106 {
   ...
   r0h = icmpsel r14, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaaafd61d100, n=1, inv
} -> block107 block108  from block104 block105
...
outer_iters=10  inner_batch=16  total_dispatches=160  total=2.593234806s  per-dispatch=16.207717ms  3709.9 GFLOPS
   mov      u67, r29
