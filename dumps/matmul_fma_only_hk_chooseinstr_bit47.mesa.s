...
block1 {
   ...
   136 = phi 95, 418
   137 = phi 79, 417
   if_icmp 135, 91, #0xaaab3bb15130 /* 0.005411 */, n=1, inv
} -> block2 block3  from block0 block12

block2 {
   break #0xaaab3bb135c0 /* 0.005408 */, n=2
} -> block13  from block1

block3 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bb15130 /* 0.005411 */, n=1
   pop_exec #0x0, n=1
} -> block4  from block1

block4 {
   if_icmp u30l, #0, #0xaaab3bb2b650 /* 0.005454 */, n=1, inv
...
block6 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bb2b650 /* 0.005454 */, n=1
   pop_exec #0x0, n=1
} -> block7  from block4
...
block8 {
   ...
   293 = phi 134, 343
   294 = phi #0, 416
   if_icmp 294, #16, #0xaaab3bb2d5f0 /* 0.005458 */, n=1, inv
} -> block9 block10  from block7 block11

block9 {
   break #0xaaab3bb2ba90 /* 0.005454 */, n=2
} -> block12  from block8

block10 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bb2d5f0 /* 0.005458 */, n=1
   pop_exec #0x0, n=1
} -> block11  from block8
...
block11 {
   ...
   416 = iadd 294, #1, #0x0
   jmp_exec_any #0xaaab3bb2bbd0 /* 0.005455 */
   pop_exec #0x0, n=1
} -> block8  from block10
...
block12 {
   ...
   418 = iadd 136, #8, #0x0
   419 = iadd 135, #32, #0x0
   jmp_exec_any #0xaaab3bb13700 /* 0.005408 */
   pop_exec #0x0, n=1
} -> block1  from block9
...
block13 {
   ...
   if_icmp 432h, #0, #0xaaab3bc5ff20 /* 0.006042 */, n=1, inv
...
block15 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc5ff20 /* 0.006042 */, n=1
   pop_exec #0x0, n=1
} -> block16  from block13
...
block16 {
   ...
   if_icmp 441h, #0, #0xaaab3bc60e90 /* 0.006044 */, n=1, inv
...
block18 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc60e90 /* 0.006044 */, n=1
   pop_exec #0x0, n=1
} -> block19  from block16
...
block19 {
   ...
   if_icmp 451h, #0, #0xaaab3bc61e80 /* 0.006046 */, n=1, inv
...
block21 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc61e80 /* 0.006046 */, n=1
   pop_exec #0x0, n=1
} -> block22  from block19
...
block22 {
   ...
   if_icmp 461h, #0, #0xaaab3bc62e70 /* 0.006048 */, n=1, inv
...
block24 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc62e70 /* 0.006048 */, n=1
   pop_exec #0x0, n=1
} -> block25  from block22
...
block25 {
   ...
   if_icmp 470h, #0, #0xaaab3bc64490 /* 0.006051 */, n=1, inv
...
block27 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc64490 /* 0.006051 */, n=1
   pop_exec #0x0, n=1
} -> block28  from block25
...
block28 {
   ...
   if_icmp 477h, #0, #0xaaab3bc65340 /* 0.006052 */, n=1, inv
...
block30 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc65340 /* 0.006052 */, n=1
   pop_exec #0x0, n=1
} -> block31  from block28
...
block31 {
   ...
   if_icmp 485h, #0, #0xaaab3bc661f0 /* 0.006054 */, n=1, inv
...
block33 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc661f0 /* 0.006054 */, n=1
   pop_exec #0x0, n=1
} -> block34  from block31
...
block34 {
   ...
   if_icmp 493h, #0, #0xaaab3bc670a0 /* 0.006056 */, n=1, inv
...
block36 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc670a0 /* 0.006056 */, n=1
   pop_exec #0x0, n=1
} -> block37  from block34
...
block37 {
   ...
   if_icmp 504h, #0, #0xaaab3bc68080 /* 0.006058 */, n=1, inv
...
block39 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc68080 /* 0.006058 */, n=1
   pop_exec #0x0, n=1
} -> block40  from block37
...
block40 {
   ...
   if_icmp 514h, #0, #0xaaab3bc69100 /* 0.006060 */, n=1, inv
...
block42 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc69100 /* 0.006060 */, n=1
   pop_exec #0x0, n=1
} -> block43  from block40
...
block43 {
   ...
   if_icmp 525h, #0, #0xaaab3bc6a180 /* 0.006062 */, n=1, inv
...
block45 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc6a180 /* 0.006062 */, n=1
   pop_exec #0x0, n=1
} -> block46  from block43
...
block46 {
   ...
   if_icmp 536h, #0, #0xaaab3bc6b200 /* 0.006064 */, n=1, inv
...
block48 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc6b200 /* 0.006064 */, n=1
   pop_exec #0x0, n=1
} -> block49  from block46
...
block49 {
   ...
   if_icmp 544h, #0, #0xaaab3bc6c010 /* 0.006065 */, n=1, inv
...
block51 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc6c010 /* 0.006065 */, n=1
   pop_exec #0x0, n=1
} -> block52  from block49
...
block52 {
   ...
   if_icmp 551h, #0, #0xaaab3bc6cec0 /* 0.006067 */, n=1, inv
...
block54 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc6cec0 /* 0.006067 */, n=1
   pop_exec #0x0, n=1
} -> block55  from block52
...
block55 {
   ...
   if_icmp 559h, #0, #0xaaab3bc6dd70 /* 0.006069 */, n=1, inv
...
block57 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc6dd70 /* 0.006069 */, n=1
   pop_exec #0x0, n=1
} -> block58  from block55
...
block58 {
   ...
   if_icmp 567h, #0, #0xaaab3bc6ec20 /* 0.006071 */, n=1, inv
...
block60 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc6ec20 /* 0.006071 */, n=1
   pop_exec #0x0, n=1
} -> block61  from block58
...
block61 {
   ...
   if_icmp 576h, #0, #0xaaab3bc6fad0 /* 0.006072 */, n=1, inv
...
block63 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc6fad0 /* 0.006072 */, n=1
   pop_exec #0x0, n=1
} -> block64  from block61
...
block64 {
   ...
   if_icmp 583h, #0, #0xaaab3bc70980 /* 0.006074 */, n=1, inv
...
block66 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc70980 /* 0.006074 */, n=1
   pop_exec #0x0, n=1
} -> block67  from block64
...
block67 {
   ...
   if_icmp 591h, #0, #0xaaab3bc71830 /* 0.006076 */, n=1, inv
...
block69 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc71830 /* 0.006076 */, n=1
   pop_exec #0x0, n=1
} -> block70  from block67
...
block70 {
   ...
   if_icmp 599h, #0, #0xaaab3bc726e0 /* 0.006078 */, n=1, inv
...
block72 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc726e0 /* 0.006078 */, n=1
   pop_exec #0x0, n=1
} -> block73  from block70
...
block73 {
   ...
   if_icmp 608h, #0, #0xaaab3bc63d20 /* 0.006050 */, n=1, inv
...
block75 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc63d20 /* 0.006050 */, n=1
   pop_exec #0x0, n=1
} -> block76  from block73
...
block76 {
   ...
   if_icmp 615h, #0, #0xaaab3bc73590 /* 0.006079 */, n=1, inv
...
block78 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bc73590 /* 0.006079 */, n=1
   pop_exec #0x0, n=1
} -> block79  from block76
...
block79 {
   ...
   if_icmp 623h, #0, #0xaaab3baac060 /* 0.005211 */, n=1, inv
...
block81 {
   else_fcmp #0.000000, #0.000000, #0xaaab3baac060 /* 0.005211 */, n=1
   pop_exec #0x0, n=1
} -> block82  from block79
...
block82 {
   ...
   if_icmp 631h, #0, #0xaaab3baacf10 /* 0.005213 */, n=1, inv
...
block84 {
   else_fcmp #0.000000, #0.000000, #0xaaab3baacf10 /* 0.005213 */, n=1
   pop_exec #0x0, n=1
} -> block85  from block82
...
block85 {
   ...
   if_icmp 639h, #0, #0xaaab3baadd20 /* 0.005214 */, n=1, inv
...
block87 {
   else_fcmp #0.000000, #0.000000, #0xaaab3baadd20 /* 0.005214 */, n=1
   pop_exec #0x0, n=1
} -> block88  from block85
...
block88 {
   ...
   if_icmp 646h, #0, #0xaaab3baaebd0 /* 0.005216 */, n=1, inv
...
block90 {
   else_fcmp #0.000000, #0.000000, #0xaaab3baaebd0 /* 0.005216 */, n=1
   pop_exec #0x0, n=1
} -> block91  from block88
...
block91 {
   ...
   if_icmp 654h, #0, #0xaaab3baafa80 /* 0.005218 */, n=1, inv
...
block93 {
   else_fcmp #0.000000, #0.000000, #0xaaab3baafa80 /* 0.005218 */, n=1
   pop_exec #0x0, n=1
} -> block94  from block91
...
block94 {
   ...
   if_icmp 662h, #0, #0xaaab3bab0930 /* 0.005220 */, n=1, inv
...
block96 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bab0930 /* 0.005220 */, n=1
   pop_exec #0x0, n=1
} -> block97  from block94
...
block97 {
   ...
   if_icmp 670h, #0, #0xaaab3bab1740 /* 0.005221 */, n=1, inv
...
block99 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bab1740 /* 0.005221 */, n=1
   pop_exec #0x0, n=1
} -> block100  from block97
...
block100 {
   ...
   if_icmp 677h, #0, #0xaaab3bab25f0 /* 0.005223 */, n=1, inv
...
block102 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bab25f0 /* 0.005223 */, n=1
   pop_exec #0x0, n=1
} -> block103  from block100
...
block103 {
   ...
   if_icmp 685h, #0, #0xaaab3bab34a0 /* 0.005225 */, n=1, inv
...
block105 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bab34a0 /* 0.005225 */, n=1
   pop_exec #0x0, n=1
} -> block106  from block103
...
block106 {
   ...
   if_icmp 693h, #0, #0xaaab3bab4350 /* 0.005227 */, n=1, inv
...
block108 {
   else_fcmp #0.000000, #0.000000, #0xaaab3bab4350 /* 0.005227 */, n=1
   pop_exec #0x0, n=1
} -> block109  from block106
...
block0 {
   ...
   $r1 = iadd ^r1, u6, #0x0
   $r1 = iadd u7, ^r1, #0x0
   r2:r3 = imad $r1.abs, u12.abs, #0, #0x0
   $r2 = imad $r3, u10, #0, #0x0
   $r2 = iadd $r1, ^r2.neg, #0x0
   $r4 = iadd $r3, #1, #0x0
   $r3 = icmpsel $r2, u10, ^r3, ^r4, #0x0
   $r4 = iadd $r2, u13, #0x0
   $r2 = icmpsel ^r2, u10, ^r2, ^r4, #0x0
   $r4 = iadd $r3, #1, #0x0
   $r3 = icmpsel $r2, u10, ^r3, ^r4, #0x0
   $r4 = iadd $r2, u13, #0x0
   $r2 = icmpsel ^r2, u10, ^r2, ^r4, #0x0
   r4:r5 = imad $r2.abs, u17.abs, #0, #0x0
   $r4 = imad $r5, u11, #0, #0x0
   $r2 = iadd ^r2, ^r4.neg, #0x0
   $r4 = iadd $r5, #1, #0x0
   $r4 = icmpsel $r2, u11, ^r5, ^r4, #0x0
   $r5 = iadd $r2, u18, #0x0
   $r2 = icmpsel ^r2, u11, ^r2, ^r5, #0x0
   $r5 = iadd $r4, #1, #0x0
   $r2 = icmpsel ^r2, u11, ^r4, ^r5, #0x0
   r4:r5 = imad $r3.abs, u15.abs, #0, #0x0
   $r4 = imad $r5, u14, #0, #0x0
   $r3 = iadd ^r3, ^r4.neg, #0x0
   $r4 = iadd $r5, #1, #0x0
   $r4 = icmpsel $r3, u14, ^r5, ^r4, #0x0
   $r5 = iadd $r3, u16, #0x0
   $r3 = icmpsel ^r3, u14, ^r3, ^r5, #0x0
   $r5 = iadd $r4, #1, #0x0
   $r3 = icmpsel ^r3, u14, ^r4, ^r5, #0x0
   $r4 = get_sr #0x0
   $r4 = iadd ^r4, u4, #0x0
   r6:r7 = imad $r4.abs, u21.abs, #0, #0x0
   $r5 = imad $r7, u20, #0, #0x0
   $r4 = iadd ^r4, ^r5.neg, #0x0
   $r5 = iadd $r7, #1, #0x0
   $r5 = icmpsel $r4, u20, ^r7, ^r5, #0x0
   $r6 = iadd $r4, u22, #0x0
   $r4 = icmpsel ^r4, u20, ^r4, ^r6, #0x0
   $r6 = iadd $r5, #1, #0x0
   $r5 = icmpsel $r4, u20, ^r5, ^r6, #0x0
   $r6 = iadd $r4, u22, #0x0
   $r4 = icmpsel ^r4, u20, ^r4, ^r6, #0x0
   $r2 = imad ^r3, u9, ^r2, #0x0
   $r3 = bfi #0, ^r4, #6, #0x0
   $r4 = imad $r5, u8, #0, #0x0
   $r6 = imad r3, u24, $r4, #0x0
   $r6 = bfeil #0, ^r6, #2, #0x0
   $r2 = imad ^r2, u29, ^r6, #0x0
   $r6 = get_sr #0x1
   $r6 = iadd ^r6, u5, #0x0
   $r6 = bfi #0, ^r6, #6, #0x0
   $r7 = imad r1, u27, $r4, #0x0
   $r7 = imad r6, u25, ^r7, #0x0
   $r8 = iadd r5, #1, #0x0
   $r8 = imad ^r8, u8, #0, #0x0
   r0l = mov_imm #0x0
   $r9 = get_sr #0x30
   $r10 = and $r9, #31
   r10 = bfeil #0, ^r10, #2, #0x0
   $r7 = bfeil #0, ^r7, #2, #0x0
   r8 = icmpsel u23, ^r8, u23, ^r8, #0x0
   r11 = bfeil #0, $r9, #6, #0x0
   r12 = bfeil #0, $r9, #5, #0x1
   r13 = and #3, $r9
   r14 = bfeil #0, $r9, #3, #0x0
   r9 = and ^r9, #7
   r15 = mov_imm #0x0
   r16 = mov_imm #0x0
   r17 = mov_imm #0x0
...
block4 {
   while_icmp r44, r8, #0x0, n=1
   jmp_exec_none_after #0xaaab3bb2ba90 /* 0.005454 */
   if_icmp u30l, #0, #0xaaab3bb2b650 /* 0.005454 */, n=1, inv
   jmp_exec_none #0xaaab3bb2b650 /* 0.005454 */
} -> block5 block6  from block3

block5 {
   $r47 = imad $r14, u24, #0, #0x0
   ...
   $r54 = icmpsel $r48, #4, #15, #240, #0x0
   wait #0x0, slot 0
   $r55 = and r53h, r54
   $r54 = icmpsel $r48, #4, #0, #4, #0x0
   $r54 = bfeil #0, r55, r54, #0x0
...
block13 {
   $r6 = imad r11, #32, r6, #0x0
   $r3 = imad r12, #32, r3, #0x0
   $r6 = iadd r6, r10, #0x0
   $r3 = iadd r3, r13, #0x0
   $r5 = imad r5, u28, #0, #0x0
   $r5 = imad u36, r5, #0, #0x0
   r1 = imad r1, u28, r5, #0x0
   $r0h = icmpsel r6, u37, #1, #0, #0x0
   r0h = icmpsel r3, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc5ff20 /* 0.006042 */, n=1, inv
} -> block14 block15  from block2

block14 {
   $r5 = iadd r1, r3, #0x0
   r5 = imad r6, u38, r5, #0x0
...
block16 {
   $r0h = icmpsel r6, u42, #1, #0, #0x0
   $r5 = iadd #1, r3, #0x0
   r0h = icmpsel r5, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc60e90 /* 0.006044 */, n=1, inv
} -> block17 block18  from block14 block15

block17 {
   $r8 = iadd r1, #1, #0x0
   $r8 = iadd r8, r3, #0x0
   r8 = imad r6, u43, r8, #0x0
   device_store r43, u44:u45, r8.abs, x, #0x0, slot 0
   wait #0x0, slot 0
} -> block19  from block16
...
block19 {
   $r0h = icmpsel r6, u46, #1, #0, #0x0
   $r8 = iadd r3, #2, #0x0
   r0h = icmpsel r8, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc61e80 /* 0.006046 */, n=1, inv
} -> block20 block21  from block17 block18

block20 {
   $r9 = iadd r1, #2, #0x0
   $r9 = iadd r9, r3, #0x0
   r9 = imad r6, u47, r9, #0x0
...
block22 {
   $r0h = icmpsel r6, u50, #1, #0, #0x0
   $r9 = iadd #3, r3, #0x0
   r0h = icmpsel r9, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc62e70 /* 0.006048 */, n=1, inv
} -> block23 block24  from block20 block21

block23 {
   $r10 = iadd r1, #3, #0x0
   $r10 = iadd r10, r3, #0x0
   r10 = imad r6, u51, r10, #0x0
...
block25 {
   ...
   r0h = icmpsel r3, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc64490 /* 0.006051 */, n=1, inv
} -> block26 block27  from block23 block24
...
block28 {
   ...
   r0h = icmpsel r5, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc65340 /* 0.006052 */, n=1, inv
} -> block29 block30  from block26 block27
...
block31 {
   ...
   r0h = icmpsel r8, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc661f0 /* 0.006054 */, n=1, inv
} -> block32 block33  from block29 block30
...
block34 {
   ...
   r0h = icmpsel r9, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc670a0 /* 0.006056 */, n=1, inv
} -> block35 block36  from block32 block33
...
block37 {
   $r0h = icmpsel r6, u70, #1, #0, #0x0
   $r11 = iadd #16, r3, #0x0
   r0h = icmpsel r11, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc68080 /* 0.006058 */, n=1, inv
} -> block38 block39  from block35 block36

block38 {
   $r12 = iadd r1, r11, #0x0
   r12 = imad r6, u71, r12, #0x0
...
block40 {
   $r0h = icmpsel r6, u74, #1, #0, #0x0
   $r12 = iadd #17, r3, #0x0
   r0h = icmpsel r12, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc69100 /* 0.006060 */, n=1, inv
} -> block41 block42  from block38 block39

block41 {
   $r13 = iadd r1, #1, #0x0
   $r13 = iadd r13, r11, #0x0
   r13 = imad r6, u75, r13, #0x0
...
block43 {
   $r0h = icmpsel r6, u78, #1, #0, #0x0
   $r13 = iadd #18, r3, #0x0
   r0h = icmpsel r13, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc6a180 /* 0.006062 */, n=1, inv
} -> block44 block45  from block41 block42

block44 {
   $r14 = iadd r1, #2, #0x0
   $r14 = iadd r14, r11, #0x0
   r14 = imad r6, u79, r14, #0x0
...
block46 {
   $r0h = icmpsel r6, u82, #1, #0, #0x0
   $r14 = iadd #19, r3, #0x0
   r0h = icmpsel r14, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc6b200 /* 0.006064 */, n=1, inv
} -> block47 block48  from block44 block45

block47 {
   $r32 = iadd r1, #3, #0x0
   $r32 = iadd r32, r11, #0x0
   r32 = imad r6, u83, r32, #0x0
...
block49 {
   ...
   r0h = icmpsel r11, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc6c010 /* 0.006065 */, n=1, inv
} -> block50 block51  from block47 block48
...
block52 {
   ...
   r0h = icmpsel r12, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc6cec0 /* 0.006067 */, n=1, inv
} -> block53 block54  from block50 block51
...
block55 {
   ...
   r0h = icmpsel r13, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc6dd70 /* 0.006069 */, n=1, inv
} -> block56 block57  from block53 block54
...
block58 {
   ...
   r0h = icmpsel r14, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc6ec20 /* 0.006071 */, n=1, inv
} -> block59 block60  from block56 block57
...
block61 {
   ...
   r0h = icmpsel r3, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc6fad0 /* 0.006072 */, n=1, inv
} -> block62 block63  from block59 block60
...
block64 {
   ...
   r0h = icmpsel r5, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc70980 /* 0.006074 */, n=1, inv
} -> block65 block66  from block62 block63
...
block67 {
   ...
   r0h = icmpsel r8, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc71830 /* 0.006076 */, n=1, inv
} -> block68 block69  from block65 block66
...
block70 {
   ...
   r0h = icmpsel r9, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc726e0 /* 0.006078 */, n=1, inv
} -> block71 block72  from block68 block69
...
block73 {
   $r6 = iadd #17, r6, #0x0
   $r0h = icmpsel r6, u118, #1, #0, #0x0
   r0h = icmpsel r3, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc63d20 /* 0.006050 */, n=1, inv
} -> block74 block75  from block71 block72

block74 {
   $r24 = iadd r1, r3, #0x0
   r24 = imad r6, u119, r24, #0x0
...
block76 {
   $r0h = icmpsel r6, u122, #1, #0, #0x0
   r0h = icmpsel r5, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bc73590 /* 0.006079 */, n=1, inv
} -> block77 block78  from block74 block75

block77 {
   $r5 = iadd r1, #1, #0x0
   $r5 = iadd r5, r3, #0x0
   r5 = imad r6, u123, r5, #0x0
...
block79 {
   $r0h = icmpsel r6, u126, #1, #0, #0x0
   r0h = icmpsel r8, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3baac060 /* 0.005211 */, n=1, inv
} -> block80 block81  from block77 block78

block80 {
   $r5 = iadd r1, #2, #0x0
   $r5 = iadd r5, r3, #0x0
   r5 = imad r6, u127, r5, #0x0
   r18 = mov1 u128, #0
   r19 = mov1 u129, #0
...
block82 {
   $r0h = icmpsel r6, u130, #1, #0, #0x0
   r0h = icmpsel r9, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3baacf10 /* 0.005213 */, n=1, inv
} -> block83 block84  from block80 block81

block83 {
   $r5 = iadd r1, #3, #0x0
   $r3 = iadd r5, r3, #0x0
   r3 = imad r6, u131, r3, #0x0
   r8 = mov1 u132, #0
   r9 = mov1 u133, #0
   device_store r17, r8:r9, r3.abs, x, #0x0, slot 0
   wait #0x0, slot 0
} -> block85  from block82
...
block85 {
   ...
   r0h = icmpsel r11, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3baadd20 /* 0.005214 */, n=1, inv
} -> block86 block87  from block83 block84
...
block86 {
   ...
   r8 = mov1 u136, #0
   r9 = mov1 u137, #0
   device_store r22, r8:r9, r3.abs, x, #0x0, slot 0
   wait #0x0, slot 0
} -> block88  from block85
...
block88 {
   ...
   r0h = icmpsel r12, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3baaebd0 /* 0.005216 */, n=1, inv
} -> block89 block90  from block86 block87
...
block89 {
   ...
   r8 = mov1 u140, #0
   r9 = mov1 u141, #0
   device_store r23, r8:r9, r3.abs, x, #0x0, slot 0
   wait #0x0, slot 0
} -> block91  from block88
...
block91 {
   ...
   r0h = icmpsel r13, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3baafa80 /* 0.005218 */, n=1, inv
} -> block92 block93  from block89 block90
...
block92 {
   ...
   r8 = mov1 u144, #0
   r9 = mov1 u145, #0
   device_store r20, r8:r9, r3.abs, x, #0x0, slot 0
   wait #0x0, slot 0
} -> block94  from block91
...
block94 {
   ...
   r0h = icmpsel r14, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bab0930 /* 0.005220 */, n=1, inv
} -> block95 block96  from block92 block93
...
block95 {
   ...
   r8 = mov1 u148, #0
   r9 = mov1 u149, #0
   device_store r21, r8:r9, r3.abs, x, #0x0, slot 0
   wait #0x0, slot 0
} -> block97  from block94
...
block97 {
   $r0h = icmpsel r6, u150, #1, #0, #0x0
   r0h = icmpsel r11, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bab1740 /* 0.005221 */, n=1, inv
} -> block98 block99  from block95 block96

block98 {
   $r3 = iadd r1, r11, #0x0
   r3 = imad r6, u151, r3, #0x0
   r8 = mov1 u152, #0
   r9 = mov1 u153, #0
   device_store r7, r8:r9, r3.abs, x, #0x0, slot 0
   wait #0x0, slot 0
} -> block100  from block97
...
block100 {
   $r0h = icmpsel r6, u154, #1, #0, #0x0
   r0h = icmpsel r12, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bab25f0 /* 0.005223 */, n=1, inv
} -> block101 block102  from block98 block99

block101 {
   $r3 = iadd r1, #1, #0x0
   $r3 = iadd r3, r11, #0x0
   r3 = imad r6, u155, r3, #0x0
   r8 = mov1 u156, #0
   r9 = mov1 u157, #0
...
block103 {
   $r0h = icmpsel r6, u158, #1, #0, #0x0
   r0h = icmpsel r13, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bab34a0 /* 0.005225 */, n=1, inv
} -> block104 block105  from block101 block102

block104 {
   $r3 = iadd r1, #2, #0x0
   $r3 = iadd r3, r11, #0x0
   r3 = imad r6, u159, r3, #0x0
   r8 = mov1 u160, #0
   r9 = mov1 u161, #0
   device_store r2, r8:r9, r3.abs, x, #0x0, slot 0
   wait #0x0, slot 0
} -> block106  from block103
...
block106 {
   $r0h = icmpsel r6, u162, #1, #0, #0x0
   r0h = icmpsel r14, u19, r0h, #0, #0x0
   if_icmp r0h, #0, #0xaaab3bab4350 /* 0.005227 */, n=1, inv
} -> block107 block108  from block104 block105

block107 {
   $r1 = iadd r1, #3, #0x0
   $r1 = iadd r1, r11, #0x0
   r1 = imad r6, u163, r1, #0x0
   r2 = mov1 u164, #0
   r3 = mov1 u165, #0
   device_store r4, r2:r3, r1.abs, x, #0x0, slot 0
   wait #0x0, slot 0
} -> block109  from block106
...
block0 {
   ...
   $r0 = convert #8, ^r0, #0x0
   $r4 = imad $r2, $r0, #0, #0x0
   $r4 = iadd #0, ^r4.neg, #0x0
   r4:r5 = imad $r0.abs, ^r4.abs, #0, #0x0
   r0 = iadd ^r0, ^r5, #0x0
   uniform_store ^r0, #24, x, #0x0
   r0 = iadd #0, ^r2.neg, #0x0
   ...
   r4:r5 = imad $r0.abs, ^r2.abs, #0, #0x0
   r0 = iadd ^r0, ^r5, #0x0
   uniform_store ^r0, #34, x, #0x0
   r0 = iadd #0, ^r3.neg, #0x0
...
outer_iters=10  inner_batch=16  total_dispatches=160  total=2.362085335s  per-dispatch=14.763033ms  4073.0 GFLOPS
d0b803000       mov      u94, r0
